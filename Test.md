...
```
let nombre = 'Julian David';
let apellido = 'Cubillos Ortegón';
let username = 'jules';
let edad = 19;
...
Son bloques de codigo que me permite reutilizarla, las funciones nos permiten encapsular (guardar) bloques de código para reutilizarlos y ejecutarlos en el futuro.
...
const lastname = "Cubillos Ortegon";
const completeName = name + lastname;
const nickname = "jules";
